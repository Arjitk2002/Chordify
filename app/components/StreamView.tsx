...
export default function StreamView({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#090b26] text-gray-200">
      <Appbar />
      <div className="flex justify-center">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-12 w-screen max-w-screen-xl pt-8">
          {/* Left Sidebar - Add a Song Section */}
